...
SRC_ADDITIONAL =	additional/42_ft_printf/ft_strlen_int.c \
					...
					additional/add/ft_close_alloc.c \
					additional/add/fts_alloc_exit.c \
					...
					additional/libft_protected/ft_strchr_p.c \
					additional/libft_protected/ft_strnstr_p.c \
					...
					additional/ft_snprintf/ft_snprintf_char.c \
					additional/ft_snprintf/ft_snprintf_str.c \
					additional/ft_snprintf/ft_snprintf_nbr_base.c \
